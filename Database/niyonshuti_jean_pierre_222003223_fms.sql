...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2024 at 11:19 AM
...
--
ALTER TABLE `club`
  MODIFY `club_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `contacts`
  MODIFY `contacts_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `player`
  MODIFY `playeer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
